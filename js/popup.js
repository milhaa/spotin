...
document.getElementById('register-btn').addEventListener('click', async function(e) {
    ...
    try {
        const response = await fetch('http://spotn-backend-production.up.railway.app/api/v1/user/register', {
            method: 'POST',
            headers: {
...
document.getElementById('verify-btn').addEventListener('click', async function(e) {
    ...
    try {
        const response = await fetch('http://spotn-backend-production.up.railway.app/api/v1/user/verify', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
